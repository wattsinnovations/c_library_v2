...
static void mavlink_test_prism_vehicle_info(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_PRISM_VEHICLE_INFO >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
    ...
    mavlink_prism_vehicle_info_t packet1, packet2;
        ...
        packet1.kargo_box_loaded = packet_in.kargo_box_loaded;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_PRISM_VEHICLE_INFO_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_PRISM_VEHICLE_INFO_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_prism_vehicle_info_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_prism_vehicle_info_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_prism_vehicle_info_pack(system_id, component_id, &msg , packet1.target_system , packet1.flight_time , packet1.fpv_camera_selected , packet1.kargo_box_loaded );
    mavlink_msg_prism_vehicle_info_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_prism_vehicle_info_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.flight_time , packet1.fpv_camera_selected , packet1.kargo_box_loaded );
    mavlink_msg_prism_vehicle_info_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_prism_vehicle_info_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_prism_vehicle_info_send(MAVLINK_COMM_1 , packet1.target_system , packet1.flight_time , packet1.fpv_camera_selected , packet1.kargo_box_loaded );
    mavlink_msg_prism_vehicle_info_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_prism_propulsion_id(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_PRISM_PROPULSION_ID >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
    ...
    mavlink_prism_propulsion_id_t packet1, packet2;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_PRISM_PROPULSION_ID_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_PRISM_PROPULSION_ID_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_prism_propulsion_id_encode(system_id, component_id, &msg, &packet1);
...
static void mavlink_test_watts(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_prism_vehicle_info(system_id, component_id, last_msg);
    mavlink_test_prism_propulsion_id(system_id, component_id, last_msg);
}
