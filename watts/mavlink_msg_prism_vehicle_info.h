...
/**
 * @brief Get field fpv_camera_selected from prism_vehicle_info message
 *
 * @return   Value is zero if not selected 
 */
static inline uint8_t mavlink_msg_prism_vehicle_info_get_fpv_camera_selected(const mavlink_message_t* msg)
{
