...
typedef struct __mavlink_prism_version_info_t {
 ...
 char asset_string[32]; /*<   Name of asset */
 char version_string[32]; /*<   Name of version */
}) mavlink_prism_version_info_t;

#define MAVLINK_MSG_ID_PRISM_VERSION_INFO_LEN 65
#define MAVLINK_MSG_ID_PRISM_VERSION_INFO_MIN_LEN 65
#define MAVLINK_MSG_ID_13004_LEN 65
#define MAVLINK_MSG_ID_13004_MIN_LEN 65

#define MAVLINK_MSG_ID_PRISM_VERSION_INFO_CRC 35
#define MAVLINK_MSG_ID_13004_CRC 35

#define MAVLINK_MSG_PRISM_VERSION_INFO_FIELD_ASSET_STRING_LEN 32
...
#define MAVLINK_MESSAGE_INFO_PRISM_VERSION_INFO { \
    ...
    {  { "target_system", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_prism_version_info_t, target_system) }, \
         { "asset_string", NULL, MAVLINK_TYPE_CHAR, 32, 1, offsetof(mavlink_prism_version_info_t, asset_string) }, \
         { "version_string", NULL, MAVLINK_TYPE_CHAR, 32, 33, offsetof(mavlink_prism_version_info_t, version_string) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_PRISM_VERSION_INFO { \
 ...
 * @param asset_string   Name of asset 
...
static inline uint16_t mavlink_msg_prism_version_info_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               uint8_t target_system, const char *asset_string, const char *version_string)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_PRISM_VERSION_INFO_LEN];
    _mav_put_uint8_t(buf, 0, target_system);
    _mav_put_char_array(buf, 1, asset_string, 32);
    _mav_put_char_array(buf, 33, version_string, 32);
        memcpy(_MAV_PAYLOAD_NON_CONST(msg), buf, MAVLINK_MSG_ID_PRISM_VERSION_INFO_LEN);
#else
    mavlink_prism_version_info_t packet;
    packet.target_system = target_system;
    mav_array_memcpy(packet.asset_string, asset_string, sizeof(char)*32);
...
{
    return mavlink_msg_prism_version_info_pack(system_id, component_id, msg, prism_version_info->target_system, prism_version_info->asset_string, prism_version_info->version_string);
}
...
{
    return mavlink_msg_prism_version_info_pack_chan(system_id, component_id, chan, msg, prism_version_info->target_system, prism_version_info->asset_string, prism_version_info->version_string);
}
...
static inline void mavlink_msg_prism_version_info_send(mavlink_channel_t chan, uint8_t target_system, const char *asset_string, const char *version_string)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_PRISM_VERSION_INFO_LEN];
    _mav_put_uint8_t(buf, 0, target_system);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_prism_version_info_send(chan, prism_version_info->target_system, prism_version_info->asset_string, prism_version_info->version_string);
#else
 ...
 */
static inline void mavlink_msg_prism_version_info_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t target_system, const char *asset_string, const char *version_string)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field asset_string from prism_version_info message
 *
 * @return   Name of asset 
 */
static inline uint16_t mavlink_msg_prism_version_info_get_asset_string(const mavlink_message_t* msg, char *asset_string)
{
    return _MAV_RETURN_char_array(msg, asset_string, 32,  1);
}
...
{
    return _MAV_RETURN_char_array(msg, version_string, 32,  33);
}
...
static inline void mavlink_msg_prism_version_info_decode(const mavlink_message_t* msg, mavlink_prism_version_info_t* prism_version_info)
{
    ...
    mavlink_msg_prism_version_info_get_asset_string(msg, prism_version_info->asset_string);
